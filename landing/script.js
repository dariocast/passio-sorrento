...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        it: {
            ...
            tradition_tag: "Identità & Territorio",
            tradition_title: "I Colori e i Riti della Penisola",
            tradition_desc: "I cortei, gli orari e i percorsi delle Arciconfraternite vengono sincronizzati e aggiornati in tempo reale direttamente dal server centrale.",
            rite_black_place: "Venerdì Santo Sera",
            rite_black_title: "La Processione Nera",
            rite_black_desc: "Il silenzio solenne, i lampioni e il canto struggente del Miserere che accompagnano il Cristo Morto e la Vergine Addolorata.",
            rite_white_place: "Giovedì Santo Notte",
            rite_white_title: "La Processione Bianca",
            rite_white_desc: "Nel cuore della notte, il corteo bianco attraversa le strade nel sacro silenzio alla ricerca del Figlio e dei Sepolcri.",
            rite_devotion_place: "Penisola Sorrentina",
            rite_devotion_title: "I Simboli della Passione",
            rite_devotion_desc: "I martiri, i lampioni in ottone, i canti polifonici e i simboli penitenziali tramandati intatti da oltre quattro secoli.",
            rite_badge_live: "Live GPS & Itinerario",
        ...
        en: {
            ...
            tradition_tag: "Identity & Territory",
            tradition_title: "Colors & Sacred Rites of the Coast",
            tradition_desc: "Processions, schedules, and official routes of the Archconfraternities are synced and updated dynamically from the central server.",
            rite_black_place: "Good Friday Night",
            rite_black_title: "The Black Procession",
            rite_black_desc: "Solemn silence, antique brass lanterns, and poignant Miserere polyphony accompanying the Dead Christ and Our Lady of Sorrows.",
            rite_white_place: "Holy Thursday Night",
            rite_white_title: "The White Procession",
            rite_white_desc: "In the depth of the night, hooded white penitents traverse silent alleys searching for the Altars of Repose.",
            rite_devotion_place: "Sorrento Peninsula",
            rite_devotion_title: "Symbols of the Passion",
            rite_devotion_desc: "Martyrial relics, brass lanterns, sacred choral chants, and centuries-old penitential symbols preserved for over four hundred years.",
            rite_badge_live: "Live GPS & Route",
